...
3. 编写MyBatist的核心配置文件
   ...
   <configuration>
       ...
       <mappers>
           <mapper class="com.xing.dao.BookMapper" ></mapper>
       </mappers>
   </configuration>
   ```

4. 编写数据库对应的实体类com.xing.pojo.Books(不推荐使用lombok插件)
...
3. Spring整合service层
   ...
   <beans xmlns="http://www.springframework.org/schema/beans"
       ...
       <bean id="BookServiceImpl" class="com.xing.service.BookServiceImpl">
...
5. 编写修改书籍页面：updateBook.jsp
   ...
   ```
## 参考资料 非常感谢，在视频的参考下，作出这个ssm整合项目，以后我还会再做几个ssm整合项目的
